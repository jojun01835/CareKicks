...
import com.example.CareKicks.R;
...
public class CareActivity extends AppCompatActivity {
    ...
    TextView textStatus;
    Button btnParied, btnSearch, btnSend,btnSend2,btnSend3,btnSend4;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(CareActivity.this, permission_list, 1);
    ...
    public void onClickButtonSend(View view){
        if(connectedThread!=null){ connectedThread.write("w"); }
    }
